        ...
        <div class="directories-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
            ...
            <a href="https://ofallonrealtors.com" class="dir-card realestate" 
               style="background: white; padding: 25px; border-radius: 10px; text-decoration: none; color: #333; transition: all 0.3s ease; box-shadow: 0 2px 15px rgba(0,0,0,0.1); border-left: 5px solid #805ad5; display: block; position: relative;">
                ...
                <p style="margin: 0; font-size: 1rem; color: #666; line-height: 1.5;">
                    Home buying, selling, military relocations, luxury properties, and real estate expertise
                </p>
            </a>
    ...
    <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
        <div style="display: flex; flex-wrap: wrap; gap: 40px; margin-bottom: 40px;">
            <div style="flex: 1; min-width: 200px;">
                <h3 style="margin-bottom: 10px;">O'Fallon Realtors Directory</h3>
            ...
            <div style="flex: 1; min-width: 200px;">
                ...
                <ul style="list-style: none; margin-top: 15px;">
                    <li style="margin-bottom: 10px;"><a href="#hero" style="color: #c6aff7; text-decoration: none;">Home</a></li>
                    <li style="margin-bottom: 10px;"><a href="#matcher" style="color: #c6aff7; text-decoration: none;">Find Your Match</a></li>
                    <li style="margin-bottom: 10px;"><a href="#comparison" style="color: #c6aff7; text-decoration: none;">Comparison Chart</a></li>
                    <li style="margin-bottom: 10px;"><a href="#profiles" style="color: #c6aff7; text-decoration: none;">Agent Profiles</a></li>
                    <li style="margin-bottom: 10px;"><a href="#featured" style="color: #c6aff7; text-decoration: none;">Featured Agent</a></li>
                    <li style="margin-bottom: 10px;"><a href="#faq" style="color: #c6aff7; text-decoration: none;">FAQ</a></li>
                </ul>
            </div>
...
function loadCrossNavigation() {
    console.log('🔗 Loading cross-navigation footer...');
